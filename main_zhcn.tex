...
智能计算研究院, 高级研究专员, 助理研究员（自然科学）
\hfill
\DatestampYMD{2022}{07}{12} --
至今
\begin{itemize}
\item 完成对MuST多散射理论密度泛函计算软件的算法优化和国产超算架构上的移植优化工作，实现最高100倍的算法优化以及最高20倍的硬件优化
\item 开展强关联多体问题的模型计算工作
\item 开展基于群论的材料声子及声子间相互作用计算方法以及配套材料数据库的开发工作
\item 开展基于群论的深度神经网络势函数的开发
\item 开展应用组数值计算集群的搭建和运维，提供超百万核时算力
\end{itemize}
