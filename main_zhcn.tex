...
高级研究专员, 助理研究员（自然科学）
\begin{itemize}
\item 负责大语言模型千卡集群分布式预训练、微调和强化学习的训练工作，相应训练算法开发和优化以及集群与训练框架的软硬件协同调优
\item 带领团队开展预训练、微调的数据处理和合成工作，完成十万亿级预训练数据准备和百万级后训练数据合成
\item 带领团队开展材料领域知识模型、材料设计模型以及材料设计智能体的开发，负责数据生产工具链和训练算法开发，实现基础能力与开源同等规模模型持平、专业领域超越开源模型性能
\end{itemize}
