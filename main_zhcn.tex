...
模型Agent能力训练技术负责人
\hfill
\DatestampYMD{2026}{01}{01} --
至今

\begin{itemize}
\item 负责模型 \textbf{Agentic Coding} 能力建设，搭建数据生成、清洗、评测与训练闭环，开展 SFT / RL 数据管线开发及训练算法优化
\item 设计并开发 021 模型 \textbf{Agent Harness}，完善面向多轮工具调用与代码任务的 SFT / RL 训练框架，支撑 Agent 能力规模化训练与评测
\item 搭建支持 \textbf{1,000+ 容器并发}的 Agent 执行环境集群，面向大规模轨迹生成、数据合成与强化学习 rollout 提供高并发沙箱基础设施
\end{itemize}
...
\item 提升 021 科学基础模型（236B）在复杂推理与科学问答任务上的整体表现，推理能力接近主流领先开源模型水平
\end{itemize}
...
研究专家, 助理研究员（自然科学）
\begin{itemize}
\item 聚焦 021 模型 Coding Agent 与 SWE 能力建设，负责 Agent Harness、数据管线、SFT / RL 训练框架开发及训练算法优化
\item 开展 021 科学基础模型训练与推理能力建设，覆盖模型训练调优、CoT 推理训练及后训练方法探索
\item 完成材料科学领域模型训练全流程建设，包括训练数据构建、增量预训练、指令微调及 CoT 推理训练
\item 参与材料设计模型与材料设计智能体研发，主导数据生产工具链及训练算法设计与实现，推动模型能力在材料设计任务中的落地
...
\begin{itemize}
\item
大语言模型:  熟悉PyTorch、Megatron-LM、slime、transformers、vLLM、SGLang等大模型训练、推理相关工具，了解DeepSpeed、FSDP、模型并行等分布式训练技术，具备基于Megatron-LM、slime的开发调优经验
\item
编程语言:   
熟练掌握
Python, C/C++, Fortran
...
\begin{enumerate}
\item
郭方泰, \underline{富律文}, 袭向明, 许增辉, 谢冰
视觉语言大模型理解方法、装置、计算机设备和存储介质
2026.08, 已授权
%
\item
戚耀, 廖龙飞, \underline{富律文}, 张胜, 薛贵荣, 陈红阳, 杨江, 宋子奇
一种训练数据有效性评估方法、系统及装置
2026.01, 已授权
% %
% \item
